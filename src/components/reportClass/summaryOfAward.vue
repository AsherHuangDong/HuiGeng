<template>
  <div class="box">
    <el-tabs v-model="activeName" type="card" @tab-click="handleClick">
      <el-tab-pane label="推荐奖励" name="first">
        <br>
        <br>
        <el-col :span="23" :offset="1">
          <el-table :data="tableData1" style="width: 100%">
            ...
            <el-table-column prop="directlyReward" label="直接奖励" align="center" />
            <el-table-column prop="indirectReward" label="间接奖励" align="center" />
            <el-table-column prop="totalReward" label="总奖励" align="center" />
          </el-table>
          <el-pagination
            background
      ...
      <el-tab-pane label="分销奖励" name="second">
        <br>
        <br>
        <el-col :span="23" :offset="1">
...
<script>
  export default {
    ...
    methods: {
      ...
      getList1() {
        const url = '/api/bg/invitationInfo/recomReward/1/' + this.pageParams1.current + '/' + this.pageParams1.size
      ...
      getList2() {
        const url = '/api/bg/invitationInfo/recomReward/2/' + this.pageParams2.current + '/' + this.pageParams2.size
        this.$get(url).then(res => {
          console.log(url, res)
          if (res.code === 100) {
            if(Object.keys(res.data).length!=0) {
