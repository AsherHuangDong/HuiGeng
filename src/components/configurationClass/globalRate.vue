  ...
  <div>
    <el-dialog title="修改限额" :visible.sync="dialogFormVisible" :before-close="cancel" width="400px">
      <el-form :model="form" label-width="100px">
        ...
        <el-form-item label="买入费率" :label-width="formLabelWidth">
          <el-input v-model="form.userInRate" type="number" style="width:200px" autocomplete="off" /> %
        </el-form-item>
        <el-form-item label="卖出费率" :label-width="formLabelWidth">
          <el-input v-model="form.userOutRate" type="number" style="width:200px" autocomplete="off" /> %
        </el-form-item>
      </el-form>
...
export default {
  ...
  mounted() {
    ...
    this.form.userInRate = this.row.userInRate
    this.form.userOutRate = this.row.userOutRate
