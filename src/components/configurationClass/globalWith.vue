<template>
  <div>
    <el-dialog title="修改起提金额" :visible.sync="dialogFormVisible" :before-close="cancel" width="400px">
      <el-form :model="form" label-width="100px">
        ...
        <el-form-item label="起提金额" :label-width="formLabelWidth">
          <el-input v-model="form.startPrice" autocomplete="off" style="width:200px" />
        </el-form-item>
      </el-form>
...
export default {
  ...
  mounted() {
    ...
    this.form.startPrice = this.row.startPrice
