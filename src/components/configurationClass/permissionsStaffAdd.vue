...
<script>
export default {
  name: 'PermissionsStaffAdd',
  data() {
    return {
      repetitionMobileParams: {
        account: ''
      },
      loading: {
        submitForm: false
  ...
  methods: {
    repetitionMobile() {
      this.$post('/api/admin/repetitionMobile', this.repetitionMobileParams)
        .then(res => {
          console.log('/api/admin/repetitionMobile', res)
        })
    },
    back() {
    ...
    addAdmin() {
      this.repetitionMobile()
      this.loading.submitForm = true
      this.$post('/api/admin/addAdmin', this.ruleForm)
        .then(res => {
          console.log('/api/admin/addAdmin', res)
        }).finally(() => {
